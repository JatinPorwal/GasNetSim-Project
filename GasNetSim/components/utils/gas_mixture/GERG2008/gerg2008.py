...
#     Last change on 2/26/24, 2:20 PM
...
class GasMixtureGERG2008:
    def __init__(self, P_Pa, T_K, composition, use_numba=True):
        ...
        if use_numba:
            ...
            self.Cv_molar = properties[11]  # molar isochoric heat capacity [J/mol-K]
            self.Cp_molar = properties[12]  # molar isobaric heat capacity [J/mol-K]
            self.Cp = properties[10]  # isochoric heat capacity [J/kg-K]
            self.Cv = properties[9]  # isobaric heat capacity [J/kg-K]
